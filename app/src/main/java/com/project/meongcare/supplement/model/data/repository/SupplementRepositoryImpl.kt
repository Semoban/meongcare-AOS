...
import com.project.meongcare.supplement.model.data.remote.SupplementRetrofitClient
...
class SupplementRepositoryImpl
    @Inject
    constructor(
        private val supplementRetrofitClient: SupplementRetrofitClient,
    ) : SupplementRepository {
        private val supplementAPI
            get() = supplementRetrofitClient.supplementApi

        override suspend fun getSupplements(
            accessToken: String?,
            dogId: Long?,
            date: String,
        ...
        override suspend fun getSupplementDetail(
            accessToken: String?,
            supplementsId: Int,
        ...
        override suspend fun getSupplementDogs(
            accessToken: String?,
            dogId: Long?,
        ...
        override suspend fun checkSupplement(
            accessToken: String?,
        ...
        override suspend fun patchSupplementAlarm(
            accessToken: String?,
            supplementsId: Int,
        ...
        override suspend fun patchSupplementActive(
            accessToken: String?,
            supplementsId: Int,
            isActive: Boolean,
        ): Result<ResponseBody> =
        ...
        override suspend fun deleteSupplementsById(
            accessToken: String?,
        ...
        override suspend fun deleteSupplementById(
            accessToken: String?,
            supplementsId: Int,
        ): Int {
            val response =
