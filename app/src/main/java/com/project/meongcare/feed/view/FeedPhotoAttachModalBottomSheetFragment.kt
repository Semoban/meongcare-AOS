...
class FeedPhotoAttachModalBottomSheetFragment : BottomSheetDialogFragment() {
    private var _binding: FragmentPhotoSelectBottomSheetBinding? = null
    val binding get() = _binding!!

    private var photoListener: FeedPhotoListener? = null
    ...
    fun setPhotoListener(listener: FeedPhotoListener) {
