...
@AndroidEntryPoint
class FeedAddFragment : Fragment(), PhotoMenuListener {
    ...
    private fun initComposeView() {
        binding.composeViewFeedAddEdit.run {
            ...
            setContent {
                SemobanTheme {
                    val imageUri by feedPostViewModel.feedImage.observeAsState()
    ...
    private fun showPhotoAttachModalBottomSheet() {
        ...
        photoAttachModalBottomSheet.setPhotoMenuListener(this@FeedAddFragment)
    ...
    private fun postFeedInfo(imageURL: String?) {
        ...
        feedPostViewModel.postFeed(accessToken, feedPostRequest)
    }

    private fun observeFeedPosted() {
